...
G = nx.read_gml("/home/sscepano/D4D res/allstuff/simple dynamics/gml gephi/mod classes2.gml")
col = [str]*256
...
plt.savefig('/home/sscepano/D4D res/allstuff/simple dynamics/groups_of_subprefs_by_overall_dynamics.png',dpi=1000)
#plt.show()
