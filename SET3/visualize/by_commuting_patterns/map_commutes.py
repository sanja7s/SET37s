...
G = nx.read_gml("/home/sscepano/D4D res/allstuff/User movements graphs/commuting patterns/1/total_commuting_G_10com_775_269_v2.gml")
col = [str]*256
...
for u,v,d in G.edges(data=True):
    scaled_weight[u][v] = (d['value'] - min7s) / (max7s - min7s)
