...
def read_in_traj():
    ...
    file_name = "/home/sscepano/D4D res/allstuff/CLUSTERING/subpref res/subpref_avg_traj.tsv"
    f = open(file_name, 'r')
...
plt.savefig('/home/sscepano/D4D res/allstuff/traj/grayscale_traj_map.png',dpi=1000)
#plt.show()
